...
<script type="text/javascript">
	...
	var search_text_both = '<div class="alert alert-secondary alert-dismissible search_text_alert" role="alert">{{ _i("Search result for %(search[0].name)s with student name is %(search[1].name)s or review result is %(search[2].name)s") }}<span class="d-inline-block" tabindex="0"><button class="close reset_search" type="button" data-dismiss="alert" aria-label="Close"  data-toggle="tooltip" data-placement="bottom" title="{{ _i("Reset search") }}"><span aria-hidden="true">×</span></button></span></div>';
	var search_text_name = '<div class="alert alert-secondary alert-dismissible search_text_alert" role="alert">{{ _i("Search result for %(search[0].name)s with student name is %(search[1].name)s") }}<span class="d-inline-block" tabindex="0"><button class="close reset_search" type="button" data-dismiss="alert" aria-label="Close" data-toggle="tooltip" data-placement="bottom" title="{{ _i("Reset search") }}"><span aria-hidden="true">×</span></button></span></div>';
	var search_text_result = '<div class="alert alert-secondary alert-dismissible search_text_alert" role="alert">{{ _i("Search result for %(search[0].name)s with review result is %(search[2].name)s") }}<span class="d-inline-block" tabindex="0"><button class="close reset_search" type="button" data-dismiss="alert" aria-label="Close"  data-toggle="tooltip" data-placement="bottom" title="{{ _i("Reset search") }}"><span aria-hidden="true">×</span></button></span></div>';
	var translate = {

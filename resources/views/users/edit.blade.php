			...
			<div class="card">
				...
				<div class="card-body">
					<div class="card-text">
						...
						@endif
						{!! Form::model($user, ['method' => 'PATCH','route' => ['users.update', $user->id],'novalidate']) !!}
							<div class="row">
							    ...
							    <div class="col-xs-12 col-sm-12 col-md-12">
							        <div class="form-group">
							            ...
							            {!! Form::select('roles[]', $roles,$userRole, ['class' => 'form-control select2' . $roles_err,'multiple']) !!}
							            <span class="text-danger">{{ $errors->first('roles') }}</span>
							        </div>
							    </div>
							    <div class="col-xs-12 col-sm-12 col-md-12 text-center">
							    	{!! Form::submit(_i('Update profile'), ['class' => 'btn btn-primary']) !!}

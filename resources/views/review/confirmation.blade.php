		...
		<div class="col-xl-6">
			<div class="card">
				...
				<div class="card-body">
							...
							<form action="/abstract/detail" method="POST">
								@csrf <!-- {{ csrf_field() }} -->
								<div class="form-group">
								<label for="mailcontent">メール内容</label>
									<textarea name="reviews" class="form-control mb-3" id="mailcontent" rows="10">{Name}先生
...
{Link}
								...
								<div class="form-group">
									...
									<input type="destination" class="form-control mb-3" id="destination" placeholder="田中太郎先生、田中五郎先生、田中一郎先生">
								</div>
